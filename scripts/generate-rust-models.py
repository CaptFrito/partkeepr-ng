...
# relations) in `backend/src/handlers/`. PartCategory keeps its codegen flat
# list at `/api/part_categories` AND adds a hand-written tree endpoint at
# `/api/part_categories/tree` — different paths, both useful.
