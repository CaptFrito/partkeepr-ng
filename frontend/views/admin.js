...
//
// Admin / cross-cutting features that don't belong in the
// bootstrap or any single view:
//   - Attachments (refresh / upload / delete) — shared by parts,
//     footprints, manufacturers, projects, storage locations.
//   - Lookups CRUD center pane (Manufacturers, Distributors,
//     Units, SI Prefixes, Part Units) with merge support.
//   - Delete-part confirmation dialog.
//   - escapeHtml() and other small string helpers.
//
// Loaded after api.js, before app.js. Declares refreshAttachments(),
// renderLookupsView(), confirmDeletePart(), escapeHtml() at
